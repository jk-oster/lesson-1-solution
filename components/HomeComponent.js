        ...
        this.heroList = [
            {
                ...
                link: '#/shop',
                img: 'https://picsum.photos/seed/shop/1080/1920'
            },
            {
                heading: 'AI Chat',
                text: 'Chat with yur personal AI assistant',
                link: '#/chat',
                img: 'https://picsum.photos/seed/bot/1080/1920'
            },
            {
                heading: 'Todo App',
    ...
    template() {
        ...
        <section id="main_content">
            ...
            <hero-teaser-component 
                background-image="https://picsum.photos/seed/cafe/1080/1920"
                text="I am a custom value for the Hero-Text"
                heading="Wanna have it?">
            </hero-teaser-component>

            ${this.heroList.map((item) => /*html*/`
                <hero-teaser-component 
                    text="${item.text}" 
